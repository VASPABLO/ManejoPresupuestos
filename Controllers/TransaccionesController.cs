    ...
    public class TransaccionesController: Controller
    {
        ...
        public async Task<IActionResult> Mensual(int año)
        {
            ...
            for( int mes = 1; mes <= 12; mes++)
            {
                ...
                if( transaccion is null)
                {
                    ...
                    {
                        Mes = mes,
                        FecheaReferencia = fechaReferencia
                    });
                }
                else
                {
                    transaccion.FecheaReferencia = fechaReferencia;
                }
            }
        ...
        public async Task<JsonResult> ObtenerTransaccionesCalendario(DateTime start, DateTime end)
        {
            ...
            var eventosCalendario = transacciones.Select(transaccion => new EventoCalendario()
            {
                ...
                Color = transaccion.TipoOperacionId == TipoOperacion.Ingreso ? "Red" : null
            });
        ...
        public async Task<IActionResult> Crear(TransaccionCreacionViewModel modelo)
        {
            ...
            if (modelo.TipoOperacionId == TipoOperacion.Ingreso)
            {
                modelo.Monto *= -1;
            }
